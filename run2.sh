...
steps/make_mfcc.sh --mfcc-config conf/mfcc2.conf --nj 112 data/train_digits exp/make_mfcc/train_digits
...
steps/make_mfcc.sh --nj 1 data/test_digits exp/make_mfcc/test_digits
